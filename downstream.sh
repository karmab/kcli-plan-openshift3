...
oc cluster up --public-hostname ${IP}.nip.io --routing-suffix ${IP}.nip.io --image=registry.access.redhat.com/openshift3/ose --enable=router,registry,web-console,persistent-volumes,rhel-imagestreams
